...
function recebeArry() {
       novaSaida = [];    
    for (let cont = 0; cont < entradaNum.length; cont++ ){
        if (!novaSaida.includes(entradaNum[cont])){
            novaSaida.push(entradaNum[cont]);
        }

    }
    console.log("resultado :", novaSaida);
}
let entradaNum = [1, 1, 2, 2, 3, 3, 4];
console.log("nummero original :", entradaNum);
recebeArry();
//  
