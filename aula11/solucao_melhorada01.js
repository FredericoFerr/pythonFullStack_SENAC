...
const p2 = new Produto("Mouse sem fio", 80, 10);
const p3 = new Produto("teclado", 90, 5);

// Criando cliente
const cliente1 = new Cliente("Fred Silva", "Rua LP, 76");
//const cliente2 = new Cliente("Ana Maria", "rua xx, 32");

// Adicionando ao carrinho
cliente1.adicionarAoCarrinho(p1, 1);
cliente1.adicionarAoCarrinho(p2, 1);
cliente1.adicionarAoCarrinho(p3, 1);
//cliente2.adicionarAoCarrinho(p2, 1);
//cliente2.adicionarAoCarrinho(p3, 1);
